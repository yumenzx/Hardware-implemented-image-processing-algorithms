...
# Switches
set_property PACKAGE_PIN V17 [get_ports {selected_kernel[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {selected_kernel[0]}]
set_property PACKAGE_PIN V16 [get_ports {selected_kernel[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {selected_kernel[1]}]
set_property PACKAGE_PIN W16 [get_ports {selected_kernel[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {selected_kernel[2]}]
...
set_property PACKAGE_PIN R2 [get_ports {selected_image}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {selected_image}]
 

# LEDs
set_property PACKAGE_PIN U16 [get_ports {is_processing}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {is_processing}]
...
set_property PACKAGE_PIN T17 [get_ports start_process]						
	set_property IOSTANDARD LVCMOS33 [get_ports start_process]
